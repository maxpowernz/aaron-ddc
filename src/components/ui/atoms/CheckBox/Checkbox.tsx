      ...
      <div className="group inline-flex p-1.5">
        <div className="relative inline-flex">
          ...
          <div
            ...
            } bg-white absolute opacity-20 w-[30px] h-[30px] -z-20 m-auto top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 transition-colors duration-300 ease-in`}
          ></div>
        </div>
